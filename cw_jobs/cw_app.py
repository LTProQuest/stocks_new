...
try:
    ...
    for page_number in range(page_limit):
        ...
        for link in view_candidate_links:
            ...
            candidate_post_url = "https://keveren.com/api/candidates/postcontractor"
    ...
    if e is IndexError():
        print("Please check you are signed into CWJobs on Firefox and restart the application")
